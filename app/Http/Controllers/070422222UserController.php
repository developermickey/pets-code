...
public function petDetails($id)
{
 ...
 public function saveStep3(Request $request){
      ...
      $user = \DB::table("pet_registration")->where('user_id',\Auth::user()->id)
    ->update(["immunized"=>$request->immunized,"certificate"=>$request->certificate,"st_passport_size"=>$st_passport_size,'owner_photo'=>$owner_photo,'owner_proof_photo'=>$owner_proof_photo,'step3'=>'1',"veterinary_health_certificate"=>$veterinary_health_certificate,"vaccination_card"=>$vaccination_card,'sterilization_certificate'=>$sterilization_certificate,'step4'=>'1']);

      } else {

      $user = \DB::table("pet_registration")->where('user_id',\Auth::user()->id)
    ->update(["immunized"=>$request->immunized,"certificate"=>$request->certificate,"st_passport_size"=>$st_passport_size,'owner_photo'=>$owner_photo,'owner_proof_photo'=>$owner_proof_photo,'step3'=>'1',"vaccination_card"=>$vaccination_card,'sterilization_certificate'=>$sterilization_certificate,'step4'=>'1']);

                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                      ...
                                      <img src="{{@$value->photo}}" width="50" height="50" alt=""/>
                                      @else
                                      N/A
                                      @endif
                                    </td>
                                    ...
                                    <td>{{ $value->dog_color }}</td>
                                    <td>{{ $value->dob }}</td>
                                    <td>{{ $value->age_in_year }}</td>
                                    <td>{{ $value->age_in_month }}</td>
                                    <td> 
                                       <a href="{{route('editYourPet',$value->id)}}"><span style="margin:5px;" class="btn btn-sm btn-info">Edit</span></a>
                                       <a href="{{route('yourPetDelete',$value->id)}}" onclick="return confirm('Are you sure to delete?')"><span style="margin:5px;" class="btn btn-sm btn-danger">Delete</span></a>
                                    </td>
                                 </tr>
                                 @endforeach
                              </tbody>

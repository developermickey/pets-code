                        ...
                        <div class="card">
                           ...
                           @if(\Auth::user()->role_id=='admin')
                             ...
                             <div class="card-header" style="margin: auto;">
                              <h4 class="card-title">Gurugram Pet Registration Form Preview 
                                <a href="{{route('generatePDF')}}?id={{$petData->id}}" class="btn btn-danger" style="margin-left: 150px;">Dowload Form PDF</a>
                                </h4>
                               
                            </div>
                            @else
                            
                              <div class="card-header text-center" style="margin: auto;">
                              <h4 class="card-title">Gurugram Pet Registration Form Preview 
                    ...
                    <div id="default_collapseThree" class="collapse accordion__body" data-parent="#accordion-one">
                        <div class="accordion__body--text">
											...
											<div class="col-lg-6 col-sm-12 col-6 mt-5 ">
												...
												<img src="{{@$petData->owner_proof_photo1}}" width="250" height="220" alt=""/>
												@endif
											</div>

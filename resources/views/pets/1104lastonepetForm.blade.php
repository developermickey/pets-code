                                                 ...
                                                 <!--  <div class="card-header">
                                                  ...
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="1st_passport_size" id="1st_passport_size" required>
                                                  ...
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="owner_photo" name="owner_photo" required>
                                                        <label class="custom-file-label"></label>
                                                      </div><br>
                                                  ...
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="owner_proof_photo" id="owner_proof_photo" required>
                                                        <label class="custom-file-label"></label>
                                                      </div><br>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      ...
                                                      <div class="input-group mt-2 mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" name="sterilization_certificate" id="sterilization_certificate" required>
                                                          <label class="custom-file-label"></label>
                                                        </div>
                                                      </div>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      ...
                                                      <div class="input-group mt-2 mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" id="vaccination_card" name="vaccination_card" required>
                                                          <label class="custom-file-label"></label>
                                                        </div>
                                                      </div>
                                                  ...
                                                  <br><br>
                                                    <p>In case you do not have the vaild Veterinary Health Certificate and/or the Vaccination Certificate of the dog, Book a doorstep Vet visit with us now!   </p>

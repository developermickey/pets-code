   ...
   <body>
      ...
      <div class="content-body">
         <div class="container-fluid">
            ...
            <br>
            <h1 class="myh1" style="text-align: center; font-size: 20px;">Update Pet Details</h1>
            <br>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        ...
                        <div id="accordion-one" class="accordion accordion-primary">
                           <form action="{{route('updatePetdetails')}}" method="post" enctype="multipart/form-data" id="finalSubmitUpdateForm">
                           @csrf 
                              ...
                              <div id="default_collapseOne" class="collapse accordion__body show" data-parent="#accordion-one">
                                 <div class="accordion__body--text">
                                    <!-- <form action="#" method="post" id="step1-form"> -->
                                       <!-- @csrf   -->
                                       <input type="hidden" name="update_id" value="{{ $petData->id }}">
                                       <div class="row">
                           ...
                           <div class="accordion__item" >
                              <div class="accordion__header rounded-lg collapsed" data-toggle="collapse" data-target="#default_collapseTwo" id="step2">
                                          ...
                                          <div class="col-lg-6 mb-2">
                                             <div class="form-group">
                                                ...
                                                <select name="age_in_year" id="age_in_year" class="btn btn-primary light form-control default-select" required error-msg="Please enter age of dog in years">
                                                   <option value="0" {{ @$petData->age_in_year == '0' ? 'selected' : '' }}>0</option>

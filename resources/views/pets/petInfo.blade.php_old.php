                        ...
                        <div class="card">
                           ...
                           @if(\Auth::user()->role_id=='admin')
                             ...
                             <div class="card-header">
                                <h4 class="card-title">Gurugram Pet Registration Form Preview <a href="{{route('generatePDF')}}?id={{$petData->id}}" class="btn btn-danger" style="margin-left: 150px;">Dowload Form PDF</a></h4>
                            </div>
                            @else

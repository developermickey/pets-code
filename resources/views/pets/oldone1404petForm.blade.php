...
@endphp
        ...
        <div class="content-body">
            <div class="container-fluid">
             ...
             <br>
              <h1 class="myh1" style="text-align: center; font-size: 20px;">Please note - in case you have multiple pets then please use a different email id for every registration</h1><br>
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gurugram Pet Registration Form <a href="{{route('generatePDF')}}" class="btn btn-danger" style="margin-left: 150px;">Dowload Form PDF</a></h4>
                            </div>
                  ...
                  <div class="card-body">
                   ...
                   <div id="accordion-one" class="accordion accordion-primary">
                                                 ...
                                                 <!--  <div class="card-header">
                                                  ...
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        ...
                                                        <input type="file" class="custom-file-input" name="1st_passport_size" id="1st_passport_size"  {{(!empty($petData->st_passport_size))?'':'required'}}>
                                                        <label class="custom-file-label"></label>
                                                      </div>
                                                      
                                                    </div>
                                                    @if(!empty($petData->st_passport_size))
                                                    <img src="{{@$petData->st_passport_size}}" width="150" height="150" alt=""/>
                                                    @endif
                                                  </div>
                                                  ...
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="owner_photo" name="owner_photo" {{(!empty($petData->owner_proof_photo))?'':'required'}}>
                                                        <label class="custom-file-label"></label>
                                                      </div><br>
                                                      
                                                    </div>
                                                    @if(!empty($petData->owner_proof_photo))
                                                    <img src="{{@$petData->owner_photo}}" width="150" height="150" alt=""/>
                                                    @endif
                                                  </div>
                                                  <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                                    ...
                                                    <div class="input-group mt-2 mb-3">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" name="owner_proof_photo" id="owner_proof_photo" {{(!empty($petData->owner_proof_photo))?'':'required'}}>
                                                        <label class="custom-file-label"></label>
                                                      </div><br>
                                                      
                                                    </div>
                                                    @if(!empty($petData->owner_proof_photo))
                                                    <img src="{{@$petData->owner_proof_photo}}" width="150" height="150" alt=""/>
                                                    @endif
                                                  </div>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      ...
                                                      <div class="input-group mt-2 mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" name="sterilization_certificate" id="sterilization_certificate" {{(!empty($petData->sterilization_certificate))?'':'required'}}>
                                                          <label class="custom-file-label"></label>
                                                        </div>
                                                      </div>
                                                        @if(!empty($petData->sterilization_certificate))
                                                       <img src="{{@$petData->sterilization_certificate}}" width="150" height="150" alt=""/>
                                                      @endif
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      ...
                                                      <div class="input-group mt-2 mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" id="vaccination_card" name="vaccination_card" {{(!empty($petData->vaccination_card))?'':'required'}}>
                                                          <label class="custom-file-label"></label>
                                                        </div>
                                                      </div>
                                                      @if(!empty($petData->vaccination_card))
                                                       <img src="{{@$petData->vaccination_card}}" width="150" height="150" alt=""/>
                                                      @endif
                                                    </div>

                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      <label class="text-label">Veterinary Health Certificate of Dog (Optinal)</label>
                                                      <div class="input-group mt-2 mb-3">
                                                        <div class="input-group-prepend">
                                                          <!--<span class="input-group-text">Upload</span>-->
                                                        </div>
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" name="veterinary_health_certificate" id="veterinary_health_certificate">
                                                          <label class="custom-file-label"></label>
                                                          
                                                        </div>
                                                      </div>
                                                      @if(!empty($petData->veterinary_health_certificate))
                                                       <img src="{{@$petData->veterinary_health_certificate}}" width="150" height="150" alt=""/>
                                                      @endif
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                                      ...
                                                      <div class="input-group mt-2 mb-3">
                                                        ...
                                                        <div class="custom-file">
                                                          <input type="file" class="custom-file-input" name="signature" id="signature" {{(!empty($petData->signature))?'':'required'}}>
                                                          <label class="custom-file-label"></label>
                                                          
                                                        </div>
                                                      </div>
                                                      @if(!empty($petData->signature))
                                                       <img src="{{@$petData->signature}}" width="150" height="150" alt=""/>
                                                      @endif
                                                    </div>
                                                  ...
                                                  <br><br>
                                                  <center> <p>In case you do not have the vaild Veterinary Health Certificate and/or the Vaccination Certificate of the dog, Book a doorstep Vet visit with us now!</p></center><br><br> 
                                                  <center> <p><a href="tel:+91 966766133"> <span type="tel" class="btn btn-primary">Shedule Call</span></a></p></center> 

                                                   
                                                    <center><button type="submit" class="btn btn-primary">Final Submit</button></center> 
                                 ...
                                 <div class="col-md-12 text-center">
                                   ...
                                   @if(@$petData->step4=='0' || @$petData->step1=='0' || @$petData->step2=='0' || @$petData->step3=='0' || empty($petData))
                                     <span class="btn btn-secondary">Proceed To Payment</span>
                                    @elseif(@$petData->step4=='1' && @$petData->payment_status=='Pending')
                                     <span class="btn btn-danger">Proceed To Payment</span>
                                    @elseif(@$petData->step4=='1' && @$petData->payment_status=='Completed')

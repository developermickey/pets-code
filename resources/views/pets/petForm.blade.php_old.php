                        ...
                        <div id="accordion-one" class="accordion accordion-primary">
                           ...
                           <div class="accordion__item">
                              ...
                              <div id="default_collapseThree" class="collapse accordion__body" data-parent="#accordion-one">
                                       ...
                                       <div class="row emial-setup">
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" name="1st_passport_size" id="imgInp"  {{(!empty($petData->st_passport_size))?'':'required'}}>
                                          ...
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" id="imgInp2" name="owner_photo" {{(!empty($petData->owner_proof_photo))?'':'required'}}>
                                                   <label class="custom-file-label"></label>
                                                </div>
                                                <br>
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5 ">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" name="owner_proof_photo" id="imgInp3" {{(!empty($petData->owner_proof_photo))?'':'required'}}>
                                                   <label class="custom-file-label"></label>
                                                </div>
                                                <br>
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" name="sterilization_certificate" id="imgInp4" {{(!empty($petData->sterilization_certificate))?'':'required'}}>
                                                   <label class="custom-file-label"></label>
                                                </div>
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" id="imgInp5" name="vaccination_card" {{(!empty($petData->vaccination_card))?'':'required'}}>
                                                   <label class="custom-file-label"></label>
                                                </div>
                                             </div>
                                          ...
                                          <div class="col-lg-6 col-sm-12 col-6 mt-5">
                                             ...
                                             <div class="input-group mt-2 mb-3">
                                                ...
                                                <div class="custom-file">
                                                   <input type="file" class="custom-file-input" name="signature" id="imgInp7" {{(!empty($petData->signature))?'':'required'}}>
                                                   <label class="custom-file-label"></label>
                                                </div>
                                             </div>
                                 ...
                                 <br><br>
                                 <p>In case you do not have the vaild Veterinary Health Certificate and/or the Vaccination Certificate of the dog, Book a doorstep Vet visit with us now!  <a href="tel:+91 966766133"> <span type="tel" class="btn btn-primary">Schedule call</span></a></p>
                              ...
                              <div class="accordion__body--text">
                                 <table style="float: left;">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td>
                                             <p><span style="font-weight: 400;">Government fee (Rs.500) and Notarization of the Form (Rs.250)</span></p>
                                          </td>
                                          <td>
                                       ...
                                       <tr>
                                          <td>
                                             <p><strong>Total Cost (Rs. 1250)</strong></p>
                                          </td>
                                          <td>
                                             <p><span style="font-weight: 400;">---</span></p>
                                          </td>

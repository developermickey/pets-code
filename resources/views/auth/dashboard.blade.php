            ...
            <div class="col-6">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-end justify-content-center">
                      <a href="{{route('faq')}}">
                       <img class="logo-abbr mobileimgss" src="{{asset('assets/img/faq.png') }}" alt="" style="width: 200px; height: 200px; margin-left: auto;margin-right: auto;cursor: pointer;" >
                     </a>
                    </div>
                    <p class="myh1"style="text-align: center; font-size: 20px;">FAQ's</p>
                  </div>
                </div>
              </div>
